...
def index(request):
    ...
    # Under maintenance books (status = 'm')
    num_instances_maintained = BookInstance.objects.filter(status__exact='m').count()

    # loaned books (status = 'o')
    num_instances_loaned = BookInstance.objects.filter(status__exact='o').count()

    # Available books (status = 'r')
...
# Number of visits to this view, as counted in the session variable.
    ...
    context = {
        ...
        'num_instances_maintained': num_instances_maintained,
